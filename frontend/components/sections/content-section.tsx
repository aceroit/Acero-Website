        ...
        >
          ...
          {showVerticalStack && (
            ...
            >
              {allImages.map((img, idx) => (
                <div
                  key={idx}
                  className="relative min-h-0 flex-1 w-full overflow-hidden rounded-2xl border border-border bg-card"
                >
          ...
          {showSingleImage && (
            <motion.div
              variants={itemVariants}
              className={cn(
                "group relative w-full overflow-hidden rounded-2xl border border-border bg-card",
