      ...
      <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-6 max-w-sm text-muted-foreground leading-relaxed">
              Leading steel manufacturing company in the UAE. Delivering premium
              quality steel products with industrial excellence and modern
              innovation.
            </p>
        ...
        <div className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-border pt-8 sm:flex-row">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Acero Steel Manufacturing. All rights
            reserved.
          </p>
