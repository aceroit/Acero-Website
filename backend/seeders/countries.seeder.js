...
// All countries of the world with ISO 3166-1 alpha-2 codes
const countries = [
...
const seedCountries = async () => {
    try {
        ...
        if (existingCount > 0) {
            console.log(`Found ${existingCount} existing countries.`);
            console.log('To re-seed countries, please delete existing countries first or use update mode.\n');
            
            // Update existing countries or skip
            let updated = 0;
            let created = 0;
            ...
            for (const countryData of countries) {
                ...
                if (existing) {
                    ...
                    if (existing.name !== countryData.name) {
        ...
        const visibleCountries = await Country.countDocuments({ isActive: true, isVisible: true });
        
        console.log(`\nTotal countries in database: ${totalCountries}`);
        console.log(`Visible countries: ${visibleCountries}`);
        console.log('\nCountries seeding completed successfully!');
        process.exit(0);
    } catch (error) {
