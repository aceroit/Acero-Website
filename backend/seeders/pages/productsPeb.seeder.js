        ...
        const sectionsData = [
            ...
            },
            {
                ...
                content: {
                    ...
                    applications: [
                        { id: '1', name: 'Aircraft Hangar', icon: 'Plane', redirectUrl: '/projects' },
                        { id: '2', name: 'Distribution Center', icon: 'Warehouse', redirectUrl: '/projects' },
                        { id: '3', name: 'Multi Story', icon: 'Building2', redirectUrl: '/projects' },
                        { id: '4', name: 'Refinery System', icon: 'Factory', redirectUrl: '/projects' },
                        { id: '5', name: 'Steel Platform', icon: 'Layers', redirectUrl: '/projects' },
                        { id: '6', name: 'Desalination Plant', icon: 'Droplets', redirectUrl: '/projects' },
                        { id: '7', name: 'Accommodation Camp', icon: 'Home', redirectUrl: '/projects' },
                        { id: '8', name: 'Modular House', icon: 'Building', redirectUrl: '/projects' },
                        { id: '9', name: 'Exhibition Hall', icon: 'Palette', redirectUrl: '/projects' },
                        { id: '10', name: 'Office Building', icon: 'Briefcase', redirectUrl: '/projects' },
                        { id: '11', name: 'Residential Building', icon: 'Home', redirectUrl: '/projects' },
                        { id: '12', name: 'Sugar Mill', icon: 'Wheat', redirectUrl: '/projects' },
                        { id: '13', name: 'Airport Structure', icon: 'PlaneTakeoff', redirectUrl: '/projects' },
                        { id: '14', name: 'Racking System', icon: 'Package', redirectUrl: '/projects' },
                        { id: '15', name: 'Factory Building', icon: 'Factory', redirectUrl: '/projects' },
                        { id: '16', name: 'Pipe Rack', icon: 'Layers', redirectUrl: '/projects' },
                        { id: '17', name: 'Shopping Center', icon: 'ShoppingBag', redirectUrl: '/projects' },
                        { id: '18', name: 'Supermarket', icon: 'Store', redirectUrl: '/projects' },
                        { id: '19', name: 'Bridge Structure', icon: 'Layers', redirectUrl: '/projects' },
                        { id: '20', name: 'Steel Mill', icon: 'Hammer', redirectUrl: '/projects' },
                        { id: '21', name: 'Field Hospital', icon: 'Cross', redirectUrl: '/projects' },
                        { id: '22', name: 'Power Plant', icon: 'Zap', redirectUrl: '/projects' },
                        { id: '23', name: 'Showroom', icon: 'Store', redirectUrl: '/projects' },
                        { id: '24', name: 'Warehouse', icon: 'Warehouse', redirectUrl: '/projects' },
                        { id: '25', name: 'Cold Storage', icon: 'Snowflake', redirectUrl: '/projects' },
                        { id: '26', name: 'Workshop', icon: 'Wrench', redirectUrl: '/projects' },
                        { id: '27', name: 'Flour Mill', icon: 'Wheat', redirectUrl: '/projects' },
                        { id: '28', name: 'Processing Mill', icon: 'Cog', redirectUrl: '/projects' },
                        { id: '29', name: 'Sports Center', icon: 'Trophy', redirectUrl: '/projects' },
                        { id: '30', name: 'Water Tower', icon: 'Droplet', redirectUrl: '/projects' },
                    ],
                },
            },
            {
