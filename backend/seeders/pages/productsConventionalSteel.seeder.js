        ...
        const sectionsData = [
            ...
            },
            {
                ...
                content: {
                    ...
                    applications: [
                        { id: '1', name: 'Pipe Racks', icon: 'Layers' },
                        { id: '2', name: 'Equipment', icon: 'Cog' },
                        { id: '3', name: 'Desalination Plant', icon: 'Droplets' },
                        { id: '4', name: 'Petrochemical Plant', icon: 'Factory' },
                        { id: '5', name: 'Steel Mill', icon: 'Hammer' },
                        { id: '6', name: 'Bridge Structure', icon: 'Layers' },
                        { id: '7', name: 'Cement Plant', icon: 'Factory' },
                        { id: '8', name: 'Oil and Gas', icon: 'Droplets' },
                    ],
                },
            },
        ];
